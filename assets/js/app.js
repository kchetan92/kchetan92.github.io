...
var _Wallop = __webpack_require__(2);
...
var consoleImage = "/assets/img/console.gif";
...
function initHeader() {
    var header = (0, _jquery2.default)('.floating-header');
...
function initNav() {
    var allTitles = document.querySelectorAll('[nav-title]');
    ...
    setInterval(function () {
        ...
        dir.forEach(function (el) {
            var thisTop = el.page.getBoundingClientRect().top;
...
function highlightNavigate() {
    if ((0, _jquery2.default)('.navigate').length < 1) {
        return;
    } else {
        var url = window.location.href;
        var projects = (0, _jquery2.default)('.navigate .project');

        _jquery2.default.each(projects, function (i) {
            var element = (0, _jquery2.default)(projects[i]);
...
function initLightBox() {
    ...
    var allImages = document.getElementsByClassName("lightbox-enable");
    var modal = document.getElementById("lightbox");
    var modalImage = modal.getElementsByClassName("main")[0];
    var closeImage = modal.getElementsByClassName("closeIcon")[0];
    ...
    for (var i = allImages.length; i--; i > 0) {
        allImages[i].addEventListener("click", function (im) {
            var src = im.target.getAttribute("src");
            openModal(src);
        });
    }
}
...
(0, _jquery2.default)(document).ready(function () {
    ...
    var allBlades = document.querySelectorAll('.blade');
    ...
    var updateField = function updateField(ev) {
    ...
    function point() {
        allBlades.forEach(function (el) {
            ...
            var angle = Math.atan(-1 * (mouseCoordinates.y - elCoordinates.y) / (elCoordinates.x - mouseCoordinates.x)) * (180 / 3.141) + 90;
